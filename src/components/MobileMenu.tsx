  ...
  return (
    <div className="md:hidden">
      ...
      <nav
        ...
        className={`fixed right-0 top-0 z-50 flex h-full w-72 max-w-[85vw] flex-col bg-[#001A3F] shadow-2xl transition-transform duration-300 ease-out motion-reduce:transition-none ${
      ...
      >
        ...
        <div className="border-t border-white/10 p-5">
          <a
            href="#contacto"
            onClick={() => setOpen(false)}
            className="flex min-h-[48px] items-center justify-center rounded-xl bg-[#00E0FF] px-5 py-3 text-sm font-semibold text-[#001A3F] transition-colors hover:bg-white"
          >
            Hablar con nosotros →
          </a>
        </div>
