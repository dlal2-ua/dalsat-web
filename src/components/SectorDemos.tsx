...
export default function SectorDemos() {
  ...
  return (
    <section id="demos-sector" className="relative py-20 sm:py-28 bg-[#000814] border-t border-white/10 overflow-hidden">
      {/* Resplandor ambiental de fondo */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[750px] h-[450px] bg-gradient-to-tr from-[#00E0FF]/15 via-[#7C6BD6]/15 to-transparent rounded-full blur-[170px] pointer-events-none" />
      ...
      <div className="max-w-7xl lg:max-w-[1380px] mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        ...
        <div className="bg-gradient-to-b from-white/[0.1] via-white/[0.04] to-white/[0.01] border border-[#00E0FF]/40 rounded-3xl p-6 sm:p-10 backdrop-blur-3xl shadow-[0_25px_70px_rgba(0,0,0,0.8)]">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="pt-4">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-[#25D366] to-[#128C7E] hover:from-[#20bd5a] hover:to-[#0f7a6e] text-white font-extrabold px-7 py-4 rounded-2xl transition-all duration-300 shadow-[0_0_30px_rgba(37,211,102,0.4)] hover:scale-105 text-sm w-full sm:w-auto cursor-pointer"
                >
            ...
            <div className="lg:col-span-6 bg-[#00140F] border border-[#25D366]/30 rounded-3xl p-5 sm:p-6 shadow-2xl space-y-3 font-sans min-h-[320px] flex flex-col justify-between">
              ...
              <div className="flex items-center justify-between pb-3 border-b border-white/10 shrink-0">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-[#25D366] to-[#128C7E] flex items-center justify-center text-white text-sm font-bold shadow-md">
                    {activeSector.icon}
                  </div>
                  <div>
                ...
                <button
                  ...
                  className="text-[10px] bg-black/40 hover:bg-black/70 text-emerald-400 border border-emerald-500/30 px-2 py-1 rounded font-mono transition-colors cursor-pointer"
                >
                  ↻ Repetir Demo
                </button>
              </div>
              ...
              <div className="space-y-3 py-2 flex-grow overflow-y-auto">
                    ...
                    <div
                      className={`max-w-[85%] rounded-2xl px-3.5 py-2.5 text-xs sm:text-sm shadow ${
                        msg.sender === 'user'
                          ...
                          : 'bg-[#005C4B] text-white border border-emerald-500/40 rounded-tl-none shadow-[0_4px_15px_rgba(0,92,75,0.4)]'
                      }`}
                    >
                      {msg.text}
                      <div className={`text-[9px] font-mono mt-1 text-right ${msg.sender === 'user' ? 'text-white/40' : 'text-emerald-200'}`}>
                        {msg.time} {msg.sender === 'bot' && <span className="text-cyan-300 font-bold ml-1">✓✓</span>}
                      </div>
                    </div>
                  </div>
                ))}
                ...
                {isTyping && (
                  <div className="flex flex-col items-start animate-fadeIn">
                    <div className="bg-[#005C4B]/80 text-emerald-200 border border-emerald-500/30 rounded-2xl rounded-tl-none px-3.5 py-2 text-xs flex items-center gap-1.5">
