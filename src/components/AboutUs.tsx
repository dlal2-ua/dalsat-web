                ...
                {pillar.action && (
                  <div className="mt-8 pt-6 border-t border-white/10">
                    <a
                      ...
                      className="inline-flex items-center gap-2.5 px-6 py-3 rounded-xl bg-terracota hover:bg-terracota-dark text-white font-bold text-sm shadow-[0_0_20px_rgba(217,100,44,0.3)] hover:shadow-[0_0_30px_rgba(217,100,44,0.55)] hover:scale-105 transition-all duration-300"
                    >
