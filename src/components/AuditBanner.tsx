...
export default function AuditBanner() {
  ...
  return (
    <section id="auditoria" className="relative py-16 sm:py-24 bg-[#000814] border-t border-white/10 overflow-hidden">
      {/* Resplandor ambiental cian/púrpura */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[750px] h-[400px] bg-gradient-to-tr from-[#00E0FF]/20 via-[#7C6BD6]/20 to-transparent rounded-full blur-[170px] pointer-events-none" />

      <div className="max-w-7xl lg:max-w-[1380px] mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        
        <div className="bg-gradient-to-r from-white/[0.1] via-white/[0.04] to-white/[0.01] border border-[#00E0FF]/40 rounded-3xl p-6 sm:p-10 md:p-14 backdrop-blur-3xl shadow-[0_25px_70px_rgba(0,0,0,0.8)] relative overflow-hidden group hover:border-[#00E0FF]/70 transition-all duration-500">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#00E0FF]/10 border border-[#00E0FF]/30 backdrop-blur-xl shadow-[0_0_20px_rgba(0,224,255,0.25)]">
              ...
              <h2 className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight leading-tight">
                ¿Quieres saber cuánto puedes <span className="bg-gradient-to-r from-[#00E0FF] via-[#7C6BD6] to-emerald-400 bg-clip-text text-transparent">automatizar</span> en tu empresa?
              </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
                {HIGHLIGHTS.map((h, i) => (
                  <div key={i} className="bg-white/[0.03] border border-white/10 rounded-2xl p-4 backdrop-blur-md">
                    <div className="text-[#00E0FF] font-mono font-bold text-xs mb-1">
                      0{i + 1}. {h.title}
                    </div>
            ...
            <div className="lg:col-span-5 bg-black/40 border border-white/15 rounded-3xl p-6 sm:p-8 flex flex-col items-center justify-center text-center space-y-5 shadow-2xl relative overflow-hidden">
              ...
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-[#00E0FF] to-[#7C6BD6] flex items-center justify-center text-2xl shadow-[0_0_30px_rgba(0,224,255,0.4)]">
                ⚡
              </div>
              ...
              <div className="w-full space-y-3 pt-2">
                <a
                  ...
                  className="w-full py-4 rounded-2xl bg-gradient-to-r from-[#25D366] to-[#128C7E] hover:from-[#20bd5a] hover:to-[#0f7a6e] text-white font-extrabold text-sm transition-all duration-300 text-center shadow-[0_0_25px_rgba(37,211,102,0.4)] hover:scale-[1.02] block cursor-pointer flex items-center justify-center gap-2"
                >
                ...
                <a
                  href="#contacto"
                  className="block text-xs font-semibold text-[#00E0FF] hover:text-white transition-colors"
                >
