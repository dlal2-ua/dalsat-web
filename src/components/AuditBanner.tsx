            ...
            <div className="lg:col-span-5 bg-black/40 border border-white/15 rounded-3xl p-6 sm:p-8 flex flex-col items-center justify-center text-center space-y-5 shadow-2xl relative overflow-hidden">
              ...
              <div className="w-full space-y-3 pt-2">
                <a
                  ...
                  className="w-full py-4 rounded-2xl bg-terracota hover:bg-terracota-dark text-navy font-extrabold text-sm transition-all duration-300 text-center shadow-[0_0_25px_rgba(217,100,44,0.35)] hover:scale-[1.02] block cursor-pointer flex items-center justify-center gap-2"
                >
