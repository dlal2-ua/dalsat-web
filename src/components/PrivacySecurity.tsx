export default function PrivacySecurity() {
  const PILLARS = [
    ...
    {
      icon: (
        <svg className="w-6 h-6 text-[#00E0FF]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
    ...
    {
      icon: (
        <svg className="w-6 h-6 text-[#7C6BD6]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
    ...
    {
      icon: (
        <svg className="w-6 h-6 text-[#34D399]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
  ...
  return (
    <section id="seguridad" className="relative py-20 sm:py-28 bg-[#00050E] border-t border-white/10 overflow-hidden">
      {/* Resplandor ambiental verde/cian de seguridad */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-gradient-to-tr from-[#10B981]/15 via-[#00E0FF]/15 to-transparent rounded-full blur-[160px] pointer-events-none" />

      <div className="max-w-6xl mx-auto px-4 sm:px-6 w-full relative z-10">
        
        {/* Cabecera */}
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#10B981]/10 border border-[#10B981]/30 backdrop-blur-xl shadow-[0_0_20px_rgba(16,185,129,0.2)] mb-4">
            <span className="flex h-2 w-2 relative">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#10B981] opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2 w-2 bg-[#10B981]"></span>
            </span>
            <span className="text-xs font-extrabold tracking-widest uppercase text-[#10B981]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {PILLARS.map((pillar, idx) => (
            <div
              key={idx}
              className="bg-gradient-to-b from-white/[0.08] to-white/[0.02] border border-white/10 hover:border-[#10B981]/50 rounded-2xl p-6 backdrop-blur-xl transition-all duration-300 hover:scale-[1.03] group shadow-lg flex flex-col justify-between"
            >
              <div>
              ...
              <div className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between text-[10px] font-mono text-[#10B981]">
        ...
        <div className="mt-12 p-6 sm:p-8 rounded-3xl bg-gradient-to-r from-[#001A3F] via-[#002B22] to-[#001A3F] border border-[#10B981]/40 backdrop-blur-2xl shadow-[0_15px_40px_rgba(0,0,0,0.6)] flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-[#10B981]/20 border border-[#10B981]/50 shrink-0 flex items-center justify-center text-2xl">
              🛡️
            </div>
            <div>
          ...
          <a
            href="#contacto"
            className="shrink-0 px-6 py-3 rounded-xl bg-[#10B981] hover:bg-white text-[#001026] font-bold text-xs sm:text-sm transition-all duration-300 shadow-[0_0_20px_rgba(16,185,129,0.4)] hover:scale-105"
          >
            Consultar Normativa →
          </a>
        </div>
