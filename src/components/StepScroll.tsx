...
const STEPS: StepItem[] = [
  {
    step: 'PASO 01',
    number: '1',
    title: 'Estrategia rápida',
    desc: 'Analizamos tus flujos y diseñamos la arquitectura perfecta para tu negocio.',
    tag: 'Sesión de 30 min',
  ...
  },
  {
    step: 'PASO 02',
    number: '2',
    title: 'Despliegue a medida',
    desc: 'Integramos la IA en tu WhatsApp con el tono y conocimiento exacto de tu empresa.',
    tag: 'Listo en 3-5 días',
  ...
  },
  {
    ...
    desc: 'Tu agente atiende clientes de inmediato y optimizamos su precisión semana a semana.',
    tag: 'Operativo 24/7',
  ...
  return (
    <section id="como-funciona" ref={sectionRef} className="relative h-[300vh] bg-navy-900 border-t border-white/10">
      ...
      <div className="sticky top-0 h-screen w-full flex flex-col items-center justify-center overflow-hidden px-4 sm:px-6">
        ...
        <div
          className="relative z-10 max-w-5xl lg:max-w-6xl w-full flex flex-col items-center text-center mt-12 sm:mt-16 transition-all duration-75"
          style={{
